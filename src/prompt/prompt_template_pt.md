...
### `is_name_mismatch` 
1. **Descrição**: Verifique se o nome da pessoa no documento de identificação é o mesmo que ALEXANDRE CRUZ ANTUNES. Não usar nomes de filiação ou em assinatura para validar.
...
1. **Descrição**: Verifique na imagem se o número do registro geral é o mesmo que 10128710-0 SP. 
...
1. **Descrição**: Verifique se a data de nascimento no documento é a mesma que 15/01/1974. 
...
> 5. `conference_uuid` deve ser este: 019b1e73-ba40-7078-bad6-9b201eb07287.
...
```json 
{
  "conference_uuid": "019b1e73-ba40-7078-bad6-9b201eb07287",
  "criteria_descriptions": {
    ...
    "is_name_mismatch": "Nome na imagem: José Carlos da Silva. Nome inputado: ALEXANDRE CRUZ ANTUNES. Tem mismatch de nomes",
    "is_document_number_mismatch": "Número na imagem: 123.123.123-12. Número inputado: 10128710-0 SP. Não tem mismatch de números",
    "is_birthdate_mismatch": "Data de nascimento na imagem: 01/01/1990. Data de nascimento inputado: 15/01/1974. Tem mismatch de datas"
  },
